...
> {
  ...
  declare setTransactions: Sequelize.HasManySetAssociationsMixin<
    Transactions,
    number
  >;
  declare addTransaction: Sequelize.HasManyAddAssociationMixin<
    Transactions,
    number
  >;
  declare addTransactions: Sequelize.HasManyAddAssociationsMixin<
    Transactions,
    number
  >;
  declare createTransaction: Sequelize.HasManyCreateAssociationMixin<Transactions>;
  declare removeTransaction: Sequelize.HasManyRemoveAssociationMixin<
    Transactions,
    number
  >;
  declare removeTransactions: Sequelize.HasManyRemoveAssociationsMixin<
    ...
    number
  >;
  declare hasTransaction: Sequelize.HasManyHasAssociationMixin<
    Transactions,
    number
  >;
  declare hasTransactions: Sequelize.HasManyHasAssociationsMixin<
    Transactions,
    number
  >;
  ...
  declare setBeneficiaryTransactions: Sequelize.HasManySetAssociationsMixin<
    Transactions,
    number
  >;
  declare addBeneficiaryTransaction: Sequelize.HasManyAddAssociationMixin<
    Transactions,
    number
  >;
  declare addBeneficiaryTransactions: Sequelize.HasManyAddAssociationsMixin<
    Transactions,
    number
  >;
  declare createBeneficiaryTransaction: Sequelize.HasManyCreateAssociationMixin<Transactions>;
  declare removeBeneficiaryTransaction: Sequelize.HasManyRemoveAssociationMixin<
    Transactions,
    number
  >;
  declare removeBeneficiaryTransactions: Sequelize.HasManyRemoveAssociationsMixin<
    Transactions,
    number
  >;
  declare hasBeneficiaryTransaction: Sequelize.HasManyHasAssociationMixin<
    Transactions,
    number
  >;
  declare hasBeneficiaryTransactions: Sequelize.HasManyHasAssociationsMixin<
    Transactions,
    number
  >;
  ...
  declare setVerificationTokens: Sequelize.HasManySetAssociationsMixin<
    VerificationTokens,
    number
  >;
  declare addVerificationToken: Sequelize.HasManyAddAssociationMixin<
    VerificationTokens,
    number
  >;
  declare addVerificationTokens: Sequelize.HasManyAddAssociationsMixin<
    VerificationTokens,
    number
  >;
  declare createVerificationToken: Sequelize.HasManyCreateAssociationMixin<VerificationTokens>;
  declare removeVerificationToken: Sequelize.HasManyRemoveAssociationMixin<
    VerificationTokens,
    number
  >;
  declare removeVerificationTokens: Sequelize.HasManyRemoveAssociationsMixin<
    VerificationTokens,
    number
  >;
  declare hasVerificationToken: Sequelize.HasManyHasAssociationMixin<
    VerificationTokens,
    number
  >;
  declare hasVerificationTokens: Sequelize.HasManyHasAssociationsMixin<
    VerificationTokens,
    number
  >;
  ...
  declare setWalletBalances: Sequelize.HasManySetAssociationsMixin<
    WalletBalances,
    number
  >;
  declare addWalletBalance: Sequelize.HasManyAddAssociationMixin<
    WalletBalances,
    number
  >;
  declare addWalletBalances: Sequelize.HasManyAddAssociationsMixin<
    WalletBalances,
    number
  >;
  declare createWalletBalance: Sequelize.HasManyCreateAssociationMixin<WalletBalances>;
  declare removeWalletBalance: Sequelize.HasManyRemoveAssociationMixin<
    WalletBalances,
    number
  >;
  declare removeWalletBalances: Sequelize.HasManyRemoveAssociationsMixin<
    WalletBalances,
    number
  >;
  declare hasWalletBalance: Sequelize.HasManyHasAssociationMixin<
    WalletBalances,
    number
  >;
  declare hasWalletBalances: Sequelize.HasManyHasAssociationsMixin<
    WalletBalances,
    number
  >;
