          ...
          function P(e, n, i) {
            ...
            return function (r, a) {
              ...
              for (i.method = r, i.arg = a; ; ) {
                ...
                var u = h(e, n, i);
                if ("normal" === u.type) {
                  if (((o = i.done ? w : "suspendedYield"), u.arg === g))
                    continue;
                  return { value: u.arg, done: i.done };
                }
                "throw" === u.type &&
                  ((o = w), (i.method = "throw"), (i.arg = u.arg));
              }
            };
          }
          function C(e, n) {
          ...
          [
                      ...
                      g.attchs &&
                        ...
                        g.attchs.forEach(function (t) {
                          ...
                          if ("suggested-messages" === n) {
                            ...
                            o && o.length && (i = o.replace(e.regOption, "")),
                              (r = { question: i, options: t.content.options });
                          } else "file" === n ? (b = e.processFile(g)) : "ticket-form" === n && (s = !0);
                        }),
                        (h = e.parseText(o.a.rawEncode(o.a.rawDecode(g.m)))),
                        !c && h && (r = e.parseSurvey(g.m)),
                        n.push(
                          f(
                            f({}, b),
                            {},
            ...
            },
            {
              ...
              value: function (e, n) {
                ...
                if ("n" === e.t && "v" === e.ut) {
                  ...
                  "VISITOR_RATING" === e.m &&
                    ...
                    e.md.rt < 0
                      ...
                      : e.md.rt > 0
                      ? ((e.m = "thumbs-up"), (e.t = "c"))
                      : (e.m = t.Tawk_Window.app.$i18n("chat", "remove_rate")));
                }
                if ("v" === e.ut)
                  (i = this.store.getters["visitor/displayName"]), (r = e.uid);
                ...
                if (
                  (e.attchs &&
                    Array.isArray(e.attchs) &&
                    e.attchs.forEach(function (t) {
                      var n = t.type;
                      if ("suggested-messages" === n) {
                        v = !0;
                        var i = "";
                        e.m && e.m.length && (i = e.m),
                          (m = {
                  ...
                  if ("c" === e.t)
                    if ("v" === e.ut)
                      ...
                      if (
                        (this.store.commit("chat/setAgentHasMessaged", !0), n)
                      ) {
                        var _ = {
                          message: e.m,
                          attachments: e.attchs ? e.attchs : [],
                        };
                        0 === e.m.length && delete _.message,
                  ...
                  c ||
                    ((c = this.parseText(e.m)),
                    v || e.attchs || (m = this.parseSurvey(e.m)));
                }
                return (
                  b > this.store.getters["session/lastMessageTimestamp"] &&
                    ("v" === e.ut
                      ? this.store.commit("session/setLastMessageTimestamp", b)
                      : (this.store.dispatch("chat/updateUnseenMessages", y),
                        n &&
                          t.Tawk_Window.jsApi.triggerApiHandlers(
            ...
            },
            {
              ...
              value: function (t) {
                ...
                if (t) {
                  for (var n = t.split("\n"), o = 0; o < n.length; o++)
                    e || (n[o] = this.createUrl(n[o].split(" "), " "));
                  return (t = (t = n.join("\n")).replace(
                    i.a.regLineBreaks,
                    i.a.br
                  ));
              ...
              value: function (t, e) {
                for (var n = this, o = 0; o < t.length; o++)
                  t[o].match(i.a.regEmailMatch)
                    ? (t[o] = t[o].replace(i.a.regEmailMatch, function (t) {
                        return n.parseEmail(t);
                      }))
                    : t[o].match(i.a.regTelMatch)
                    ? (t[o] = t[o].replace(i.a.regTelMatch, function (t) {
            ...
            },
            {
              ...
              value: function (t) {
                ...
                for (
                  var r = "",
                    a = t.match(this.regSurveyQuestion),
                    s = 0,
                    c = n.length;
                  s < c;
                  s++
                ...
                return (
                  a &&
                    a.length &&
                    (r = (r = this.createUrl(a[0].split(/\s/), " ")).replace(
                      this.regOption,
                      ""
                    )),
                  { options: e, question: r }
                );
              },
            },
            {
            ...
            },
            {
              ...
              value: function (e) {
                ...
                if (
                  ...
                  return (
                    (n = o.a.trim(a.value)), (a.value = ""), this.sendMessage(n)
                  );
                !this.keyDownTimeout &&
            ...
            },
            {
              ...
              value: function (e) {
                ...
                var l = { message: i, attachments: a };
                0 === i.length && delete l.message,
                  t.Tawk_Window.app.$socket.publish(
                    "sendChatMessage",
                    l,
                    function (e, i) {
                      e
                        ? ((u.sendFailed = !0), (u.isPending = !1))
                        : ((u.cver = i.data.cver),
                          (u.timeStamp = new Date(i.data.co).getTime()),
                          (u.time = i.data.co),
                          (u.isPending = !1),
                          (u.rawMessage.co = i.data.co),
                          (u.sendFailed = !1),
                          t.Tawk_Window.jsApi.triggerApiHandlers(
                          ...
                          n.store.dispatch("chat/outgoingChatMessage", u)),
                        c();
                    }
                  );
              },
                ...
                for (
                  var n = this,
                    ...
                    u = function () {
                      ...
                      return t.file.size > n.maxSizeFileUpload
                        ? (o.push(t.file.name), 0)
                        : l >= n.maxNumberFileUpload
                        ? (c.push(t), 0)
                        : (n.store.commit("chat/addFileUpload", s),
                          void i.push(
                  ...
                  t.Tawk_Window.app.$socket.publish(
                    ...
                    function (e, o) {
                      ...
                      ("a" !== a.cllr.t ||
                        ...
                        i.isDone
                          ? n.store.dispatch("chat/updateOngoingCall", !1)
                          : n.store.dispatch("chat/updateOngoingCall", !0),
          ...
          e.default = {
              ...
              isRight: function (e, n, i) {
                var o,
                  ...
                  a =
                    ...
                    null === (o = o.local_API) ||
                    void 0 === o ||
                    null === (o = o.customStyle) ||
                    void 0 === o
                      ? void 0
                      : o.visibility;
                return i.browserData.mobileBrowserName
                  ? a && a.mobile && a.mobile.position
                    ? -1 !== r.indexOf(a.mobile.position)
                    : -1 !== r.indexOf(e.mobileVisibility.position)
                  : a && a.desktop && a.desktop.position
                  ? -1 !== r.indexOf(a.desktop.position)
                  : -1 !== r.indexOf(e.desktopVisibility.position);
              },
            ...
            actions: {
              ...
              start: function (e, n) {
                ...
                s("socket/updateIsConnecting", !0, { root: !0 });
                var f = a["property/id"],
                  h = a["widget/id"],
                  p = new o.a({
                    propertyId: f,
          ...
          function o() {
            ...
            function f(t, e, n, i) {
              var o = e && e.prototype instanceof v ? e : v,
                ...
                s = new x(i || []);
              return r(a, "_invoke", { value: P(t, n, s) }), a;
            }
            function h(t, e, n) {
              try {
                return { type: "normal", arg: t.call(e, n) };
            ...
            function W(t, e) {
              function n(o, r, a, c) {
                ...
                if ("throw" !== u.type) {
                  var l = u.arg,
                    d = l.value;
                  return d && "object" == s(d) && i.call(d, "__await")
                    ? e.resolve(d.__await).then(
                        function (t) {
                          n("next", t, a, c);
                        },
          ...
          [
                    ...
                    function (i, o) {
                      ...
                      n.languageScript &&
                        ...
                        (n.languageScript.src = ""
                          .concat(
                            "https://embed.tawk.to/_s/v4/app/67354992019",
                            "/languages/"
                          )
            ...
            },
            {
              ...
              value: function () {
                ...
                if (
                  ...
                  if (
                    ("string" == typeof o &&
                      (o = parseInt(i.desktop.xOffset.replace("px", ""), 10)),
                    !isNaN(o))
                  )
                    return o;
                }
            ...
            },
            {
              ...
              value: function () {
                ...
                if (
                  ...
                  if (
                    ("string" == typeof o &&
                      (o = parseInt(i.desktop.yOffset.replace("px", ""), 10)),
                    !isNaN(o))
                  )
                    return o;
                }
            ...
            },
            {
              ...
              value: function () {
                ...
                if (
                  void 0 !==
                  (null == i || null === (n = i.mobile) || void 0 === n
                    ? void 0
                    : n.xOffset)
                ) {
            ...
            },
            {
              ...
              value: function () {
                ...
                if (
                  void 0 !==
                  (null == o || null === (n = o.bubble) || void 0 === n
                    ? void 0
                    : n.xOffset)
                ) {
                ...
                if (
                  void 0 !==
                  (null == o || null === (i = o.desktop) || void 0 === i
                    ? void 0
                    : i.position)
                ) {
                  var a,
                    s =
                      null == o || null === (a = o.desktop) || void 0 === a
                        ? void 0
                        : a.position;
                  if (
                    s &&
                    this.store.getters["widget/desktopVisibility"].position !==
                      s
                  )
                    return this.store.getters["widget/isCenter"]
            ...
            },
            {
              ...
              value: function () {
                ...
                if (
                  void 0 !==
                  (null == i || null === (n = i.bubble) || void 0 === n
                    ? void 0
                    : n.rotate)
                ) {
            ...
            },
            {
              ...
              value: function () {
                var e,
                  n,
                  i = this.store.getters["widget/isRoundWidget"],
                  o =
                    null === (e = t.Tawk_Window.jsApi) ||
                    void 0 === e ||
                    null === (e = e.local_API) ||
                ...
                if (
                  void 0 !==
                  (null == o || null === (n = o.desktop) || void 0 === n
                    ? void 0
                    : n.position)
                ) {
                  var r,
                    a =
                      null == o || null === (r = o.desktop) || void 0 === r
                        ? void 0
                        : r.position;
                  if (
                    this.store.getters["widget/desktopVisibility"].position !==
                  ...
                  this.io.on("visitorChatWindowState", function (t) {
                    ...
                    (this.store.getters["widget/hasLiveChat"] ||
                      ...
                      this.io.on("visitorChatTransfer", function (e) {
                        t.Tawk_Window.chatManager.chatTransferUpdate(
                          e.transfer,
                          e.transferVersion
                        );
                      }));
          ...
          [
              ...
              value: function () {
                ...
                (t.Tawk_Window.metaContent = o && o.length ? o : null),
                  (t.Tawk_Window.hasNoScale =
                    "no" === n["user-scalable"] || "0" === n["user-scalable"]),
            ...
            },
            {
              ...
              value: function () {
                ...
                if (
                  ...
                  window.Tawk_API &&
                    !1 ===
                      (null === (e = window.Tawk_API) || void 0 === e
                        ? void 0
                        : e.autoStart) &&
                    k.a.commit("widget/setVisibility", !1),
                  k.a.dispatch(
                  ...
                  k.a.dispatch("session/updateConnectionData", {
                    ...
                    i.pop && k.a.commit("widget/setIsPopout", !0),
            ...
            },
            {
              ...
              value: function (e) {
                ...
                n.transfer &&
                  k.a.dispatch("chat/updateChatTransferData", {
                    transfer: n.transfer,
          ...
          encode: function (t) {
            ...
            for (o = r = y.length, r && y.push("-"); o < m; ) {
              for (l = i, u = 0; u < m; ++u)
                (p = t[u]) >= e && p < l && (l = p);
              for (
                l - e > s((i - n) / (w = o + 1)) && this.error("overflow"),
                  n += (l - e) * w,
                  e = l,
                  u = 0;
                u < m;
          ...
          function W(t, e) {
            function n(o, r, a, s) {
              ...
              if ("throw" !== c.type) {
                var l = c.arg,
                  d = l.value;
                return d && "object" == u(d) && i.call(d, "__await")
                  ? e.resolve(d.__await).then(
                      function (t) {
                        n("next", t, a, s);
                      },
            ...
            },
            {
              ...
              value: function (e, n, i) {
                var o = this.store.getters["property/id"],
                  ...
                  a = new Date().getTime(),
                  s = JSON.stringify({ uuid: e, version: n, domain: i, ts: a });
                          ...
                          switch ((e.prev = e.next)) {
                            ...
                            case 9:
                              (o = "".concat(
                                ...
                                (s =
                                  t.Tawk_Window.sessionManager.getStoredToken()) &&
                                  (c = { "X-Tawk-Token": s }),
                                r.a.post(
                                  o,
                                  n,
                                  ...
                                  function (e, n) {
                                    return e || (!e && !n)
                                      ...
                                      : n.error
                                      ? i(n.error)
                                      : void u.reconnectSession(function () {
                                          i(),
                                            t.Tawk_Window.eventBus.$emit(
                                              "forceUpdate"
                                            );
                                ...
                                r.a.post(
                                  ...
                                  function (e, i) {
                                    return e || (!e && !i)
                                      ...
                                      : i.error
                                      ? n(i.error)
                                      : void c.reconnectSession(function () {
                                          n(),
                                            t.Tawk_Window.eventBus.$emit(
                                              "forceUpdate"
                                            );
            ...
            actions: {
                ...
                if (((o.chat.synced = !0), !(o.chat.version >= s))) {
                  ...
                  for (
                    var d = function () {
                        var e = c[f];
                        if (!e.md || !e.md.ao) {
                          var o = t.Tawk_Window.chatManager.parseChatMessage(
                            e,
                            !0
                          );
                          o &&
              ...
              updateChatTransferData: function (t, e) {
                var n = t.commit,
                  ...
                  o = e.transfer,
                  r = e.transferVersion;
                r > i.chatTransfer.version &&
                  (n("setChatTransferData", o), n("setChatTransferVersion", r));
              },
              ...
              setSeenAllUnseenMessages: function (e) {
                ...
                if (n.chat.unseenMessages.length > 0) {
                  ...
                  r &&
                    r.timeStamp &&
                    (i("session/updateVisitorChatSeen", r.timeStamp, {
                      root: !0,
                    }),
                    i("clearUnseenMessages"),
                    t.Tawk_Window.jsApi.triggerApiHandlers(
                      "onUnreadCountChanged",
                      n.chat.unreadMessageCount
                    ));
                }
              },
            },
                        ...
                        for (;;)
                          switch ((e.prev = e.next)) {
                            ...
                            case 3:
                              if (
                                ...
                                (u =
                                  ...
                                  .length && (s = u[0]),
                                ((l = new Date().getTimezoneOffset()) < -900 ||
                                  l > 900) &&
                                  (l = 0),
                                null !== (n = window.Tawk_API) &&
                                  void 0 !== n &&
                                  null !== (n = n.visitor) &&
                                  void 0 !== n &&
                                  n.userId &&
                                  null !== (i = window.Tawk_API) &&
                                  void 0 !== i &&
                                  null !== (i = i.visitor) &&
                                  void 0 !== i &&
                                  i.hash &&
                                  (r = o.a.formatVisitorLoginData(
                                    window.Tawk_API.visitor
                                  )),
                                this.registerData
                                  ? (this.registerData.vss = s)
                                  : (this.registerData = {
                                      p: c["property/id"] || "",
                                      w: c["widget/id"],
                                      platform: c[
                            ...
                            case 27:
                              ...
                              (this.registerData.u = p),
                                (this.registerData.uv = parseInt(m, 10)),
                                2 === m && w && (this.registerData.uw = 1),
                                (e.next = 40);
                              break;
                            case 37:
                              return (
      ...
      function a() {
        ...
        return (
          ...
          (x.prototype = {
            ...
            delegateYield: function (e, n, i) {
              return (
                (this.delegate = { iterator: A(e), resultName: n, nextLoc: i }),
                "next" === this.method && (this.arg = t),
                g
              );
            },
                  ...
                  (window.$_Tawk.setAttributes = window.Tawk_API.setAttributes =
                    function (e, n) {
                      (t.Tawk_Window.jsApi.local_API.visitor =
                        t.Tawk_Window.jsApi.local_API.visitor || {}),
                        e.name &&
                          (t.Tawk_Window.jsApi.local_API.visitor.name = e.name),
                        e.email &&
                          (t.Tawk_Window.jsApi.local_API.visitor.email =
                            e.email),
                        e.hash &&
                          (t.Tawk_Window.jsApi.local_API.visitor.hash = e.hash),
                  ...
                  (window.$_Tawk.switchWidget = window.Tawk_API.switchWidget =
                    function (e) {
                      ...
                      t.Tawk_Window.jsApi._apiCheck() ||
                        t.Tawk_Window.jsApi.store.dispatch(
                          "widget/switchWidget",
                          { propertyId: i, widgetId: r, callback: a }
                        );
                    }),
                      ...
                      var e =
                        ...
                        n =
                          arguments.length > 1 && void 0 !== arguments[1]
                            ...
                            : function () {};
                      t.Tawk_Window.jsApi._apiCheck() ||
                        t.Tawk_Window.jsApi.store.dispatch("widget/start", {
                          params: e,
                          callback: n,
                        });
                    });
            ...
            },
            {
              ...
              value: function (e, n) {
                ...
                if (void 0 !== i) {
                  ...
                  if (
                    (this.dispatch(i.eventName, n), "function" == typeof i.func)
                  )
                    try {
                      i.func(n);
                    } catch (t) {}
          ...
          function r() {
            ...
            function f(t, e, n, i) {
              var o = e && e.prototype instanceof v ? e : v,
                ...
                s = new x(i || []);
              return a(r, "_invoke", { value: P(t, n, s) }), r;
            }
            function h(t, e, n) {
              try {
                return { type: "normal", arg: t.call(e, n) };
