...
export default function UpdateKYCDialog({
  user,
  isOpen,
  setIsOpen,
}: {
  ...
  useEffect(() => {
    if (isOpen) {
      ...
      setValue(
        "emailVerified",
        user?.emailVerified == 1 ? "verified" : "pending"
      );
          ...
          <div className="gap-5 flex flex-col">
            <Flex gap={"4"}>
              ...
              <Flex direction="column" gap="1" className="w-full">
                ...
                <Select.Root
                  value={watch().accountLevel}
                  onValueChange={(value) =>
                    setValue("accountLevel", value as any)
                  }
                >
                  <Select.Trigger />
                  <Select.Content>
                ...
                <Text size={"1"} color="red">
                  {errors?.accountLevel?.message.toString()}
                </Text>
              </Flex>
            </Flex>
            ...
            <Flex gap={"4"}>
              <Flex direction="column" gap="1" className="w-full">
                ...
                <Select.Root
                  value={watch().emailVerified}
                  onValueChange={(value) =>
                    setValue("emailVerified", value as any)
                  }
                >
                  <Select.Trigger />
                  <Select.Content>
                ...
                <Text size={"1"} color="red">
                  {errors?.emailVerified?.message.toString()}
                </Text>
              </Flex>
              ...
              <Flex direction="column" gap="1" className="w-full">
                ...
                <Select.Root
                  value={watch().canTransfer}
                  onValueChange={(value) =>
                    setValue("canTransfer", value as any)
                  }
                >
                  <Select.Trigger />
                  <Select.Content>
                ...
                <Text size={"1"} color="red">
                  {errors?.canTransfer?.message.toString()}
                </Text>
              </Flex>
            </Flex>
            ...
            <Flex gap={"4"}>
              <Flex direction="column" gap="1" className="w-full mt-1">
                ...
                <Select.Root
                  value={getValues("ssnStatus")}
                  onValueChange={(value) => setValue("ssnStatus", value as any)}
                >
                ...
                <Text size={"1"} color="red">
                  {errors?.ssnStatus?.message.toString()}
                </Text>
              </Flex>
              <Flex direction="column" gap="1" className="w-full">
                <CTextField
            ...
            <Flex gap={"4"}>
              <Flex direction="column" gap="1" className="w-full">
                ...
                <Select.Root
                  value={getValues("idDocStatus")}
                  onValueChange={(value) =>
                    setValue("idDocStatus", value as any)
                  }
                >
                ...
                <Text size={"1"} color="red">
                  {errors?.idDocStatus?.message.toString()}
                </Text>
              </Flex>
              <Flex direction="column" gap="1" className="w-full">
                <Text size={"1"}>ID Type</Text>
                <Select.Root
                  value={getValues("idDocType")}
                  onValueChange={(value) => setValue("idDocType", value as any)}
                >
