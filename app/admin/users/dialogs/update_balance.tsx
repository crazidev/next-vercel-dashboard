              ...
              <div className="flex flex-col">
                {list.map((e) => (
                  <div key={e.value} onClick={(i) => setSendFrom(e)}>
                    <MyCard
                      size={"1"}
                      className={`px-2 h-auto py-2 outline-0 flex flex-row items-center gap-2 cursor-pointer font-bold ${
                        sendFrom.value == e.value
                          ? "!bg-[--accent-5] border-2 border-[--accent-5]"
                          : "!bg-transparent"
                      }`}
                    >
                      <div className="">
                        ...
                        {e.value == -1 && (
                          <Logo
                            className={"h-[20px] w-[20px] fill-primary-700"}
                          />
                        )}
                      </div>
